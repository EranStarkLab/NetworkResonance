...
sig                             = 'sines';
[ ~, ~, ~, fig3( 4 ) ]          = NR_sinusoids_to_cmodel_run( model, sig, 'Dn', 'nFFT', 1250, 'dflag', dflag );
[ ~, ~, ~, fig3( 5 ) ]          = NR_sinusoids_to_cmodel_run( model, sig, 'Amp', 'nFFT', 1250, 'dflag', dflag );
[ ~, ~, ~, fig3( 6 ) ]          = NR_sinusoids_to_cmodel_run( model, sig, 'Ibias', 'nFFT', 1250, 'dflag', dflag );
...
sig                             = 'sines';
amp_vals                        = 0 : 0.0025 : 0.3;
[ ~, ~, ~ , fig3( 8 ) ]         = NR_sinusoids_to_cmodel_run( model, sig ...
    , 'Amp','nFFT', 1250, 'param_vals', amp_vals, 'dflag', dflag );
...
Vreset_LIF_C                    = -70;
sig                             = 'sines';
[ ~, ~, ~, fig3F( 3 ) ]       	= NR_sinusoids_to_cmodel_run( model, sig, 'Gc' ...
