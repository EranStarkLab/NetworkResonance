...
fig6                            = zeros( 2, nmodels );

for k                           = 1 : nmodels
    
    % what to show in the traces examples
    fvals_slct                  = [ 1 10 20 40 ];
    ...
    [ ~, ~, ~, ~, s ]           = NR_sinusoids_to_cmodel( 'LIF_syn' ...
        , 'Tlong', Tlong_sth, 'fvals', fvals_all ...
    ...
    [ ~, ~, ~, ~, sth ]         = NR_sinusoids_to_cmodel( 'LIF_syn' ...
        , 'Tlong', Tlong_sth, 'fvals', fvals_all ...
        , 'Dn', Dn_syn, 'Gs_LIF_syn', Gs_LIF_syn, 'Es_LIF_syn', Es_LIF_syn ...
        , 'nreps', 1, 'graphics', [ 0 0 0 0 ], 'synmodel_LIF_syn', synmodel ...
        , 'Ibias', Ibias_LIF_syn_sth, 'Vth_LIF_syn', Vth_LIF_syn_sth ...
        , 'SD_Out_LIF_syn', SD_Out_LIF_syn ...
        , 'dflag', dflag ...
        );
    ...
    for j                       = 1 : nfvals
        ...
        plot_raster( { s.t( find( st ) ) }, [] ...
            , ylims( 1 ) + diff( ylims ) / 4, diff( ylims ) / 2 ...
            , spike_width, spike_color );
